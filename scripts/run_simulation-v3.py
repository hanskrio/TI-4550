...
model = DQN.load("/Users/hanskrio/Desktop/NTNU/Prosjektoppgave/code/RL_energy/DDQN-2_200k.zip", env=env)

# Initialize lists to store rewards
rewards_list = []
# Loop for one episode of experience (check max_episode_length)
done = False
obs, _ = env.reset()
while not done:
